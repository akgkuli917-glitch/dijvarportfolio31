<template>
  <div class="invisible relative z-99999999 hidden md:visible md:block">
    <div
      id="cursor"
      class="fixed z-100 h-[2.5rem] w-[6rem] origin-center scale-0 rounded-md bg-flax-smoke-500 opacity-0 transition-all duration-300 ease-out"
    ></div>
