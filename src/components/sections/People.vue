    ...
    >
      ...
      >
        ...
        <p class="heading-6 font-fancy w-full text-balance sm:max-w-[40ch]">
          Here's what my collaborators say about working with me. Their success and satisfaction are my top priorities, and I strive to deliver AI-driven solutions that exceed expectations and create real impact.
        </p>
      </div>
    </div>
